            ...
            <div className="flex flex-col justify-between lg:w-3/5 p-8">
                ...
                <div className="flex flex-col lg:flex-row gap-5 pb-5">
                    <Link href={props.link}>
                        <a target='_blank' rel="noreferrer" className="flex justify-between items-center px-5 lg:w-1/2 text-center text-base sm:text-xl cursor-pointer bg-blue-600 text-white p-3 rounded-xl"><TbBrowserPlus size={35} />Visit the App</a>
                    </Link>   
                    <Link href={props.repo}>
                        <a target='_blank' rel="noreferrer" className="flex justify-between items-center px-5 lg:w-1/2 text-center text-base sm:text-xl cursor-pointer bg-gray-600 text-white p-3 rounded-xl"><BsGithub size={35} />Go to the Repository</a>
                    </Link> 
                </div>
            </div>
        </div>
