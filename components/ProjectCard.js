...
const ProjectCard = (props) => {
    return ( 
        <div className="relative h-auto w-fix flex justify-center items-center group mb-10" >
            <Image src={props.image} alt="Project_1-Image" height={600} width={350} objectFit='cover' objectPosition='center' className="relative rounded-xl group-hover:opacity-20 opacity-100" />
            <div className="absolute hidden group-hover:flex flex-col justify-between h-[75%] top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
